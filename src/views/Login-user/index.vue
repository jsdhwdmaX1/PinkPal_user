...
// import { loginAPI } from "@/stores/user2Store";
...
const rules = {
  ...
  password: [
    ...
    { max: 16, message: '密码不超过16个字符', trigger: 'blur' },
  ],
  agree: [
    {
    ...
    if (valid) {
      ...
      loginAPI( { username , password }).then(res => {
        if (res.data.code === 1) {
          ...
          // const {username,password,token}=res.data.data
          router.replace('/')
        ...
        <div class="username-box">
          <div class="form">
            ...
            <div style="text-align: right; margin-top: 30px;">
              <RouterLink to="/register-user">没有账号?去注册</RouterLink>
            </div>
          </div>
        </div>
      </div>
